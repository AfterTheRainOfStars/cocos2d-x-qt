...
void JumpingGame::initPlayer()
{
    ...
    CCArray* playerAnimationFrames = new CCArray(7);
    ...
    CCAnimation* playerAnimation = CCAnimation::animationWithSpriteFrames(playerAnimationFrames);
    ...
    m_player = CCSprite::spriteWithSpriteFrame((CCSpriteFrame*)playerAnimationFrames->objectAtIndex(0));
