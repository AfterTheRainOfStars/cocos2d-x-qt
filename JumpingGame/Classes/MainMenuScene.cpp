...
{
    // create menu items
    CCMenuItemImage* logoItem = CCMenuItemImage::itemWithNormalImage(
                                        "logo.png",
                                        "logo.png",
                                        this,
                                        NULL);
    ...
    CCMenuItemImage *playItem = CCMenuItemImage::itemWithNormalImage(
                                        "button_play.png",
    ...
    CCMenuItemImage *exitItem = CCMenuItemImage::itemWithNormalImage(
                                        "button_exit.png",
